...
const Follow = (props) => {
  return (
    ...
    >
      ...
      <Line className="mb-2" />
      <Link href="/" className="btn btn-light btn-sm bg-twitter me-2">
        <FontAwesomeIcon icon={faTwitter} className="text-white mx-1" />
      </Link>
      <Link href="/" className="btn btn-light btn-sm bg-facebook me-2">
        <FontAwesomeIcon icon={faFacebookF} className="text-white mx-1" />
      </Link>
      <Link href="/" className="btn btn-light btn-sm bg-instagram me-2">
        <FontAwesomeIcon icon={faInstagram} className="text-white mx-1" />
      </Link>
      <Link href="/" className="btn btn-light btn-sm bg-google me-2">
