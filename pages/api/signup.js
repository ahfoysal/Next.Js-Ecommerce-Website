...
export default checkAccessToken(async function handler(req, res) {
  ...
  try {
    const response = await axios.post(`https://shop.tazreemart.com/?rest_route=/simple-jwt-login/v1/users&email=${email}&password=${password}&user_login=${userName}&THISISMySpeCiaLAUthCodee=THISISMySpeCiaLAUthCodee`);
