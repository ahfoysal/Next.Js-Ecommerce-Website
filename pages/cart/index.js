...
const total2 = cart.reduce((total, prd) => total + prd.quantity , 0)
  ...
  return (<>
    {cartItems.length >= 1   && <div className='cart-page'>
...
</div> }  {cartItems < 1 && <div className='cart-page'><p> No Products In cart</p>
<div className="buttons"><Link href={'/'}><button >Continue Shopping</button></Link></div>
</div> }
   </>
  )
}
